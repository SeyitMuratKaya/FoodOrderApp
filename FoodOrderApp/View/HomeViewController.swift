...
extension HomeViewController: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        case self.popularRestaurantsCollectionView:
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case self.foodCategoryCollectionView:
            ...
            cell.setup(restaurant: Restaurant.smallCellSampleData[indexPath.row])
            return cell
        case self.popularRestaurantsCollectionView:
            ...
            cell.setup(restaurant: Restaurant.largeCellSampleData[indexPath.row])
            return cell
        default:
